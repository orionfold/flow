...
**Fictional project plan · snapshot before the 12 October decision**

**Owner:** Priya Raman · **Sponsor:** Marketing · **Target:** 14 November 2026 · **Status:** CMS decision at risk; build blocked
...
| --- | ---: | ---: | ---: |
| A visitor can find the right product with fewer clicks | mean clicks to product page | 3.4 | **≤ 2** |
...
All baseline figures are hypothetical for this exercise. Before using the targets, record the evaluation cohort, measurement window and definition of load time. Treat organic traffic retention as a migration check; seasonality and campaign changes can also affect it.
...
The campaign calendar depends on the agreed templates. [[Staff Meeting]] carries the running status.
