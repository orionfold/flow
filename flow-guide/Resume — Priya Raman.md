---
title: Resume — Priya Raman
tags: [personal, career, resume]
---
...
- Took the core product from private beta to 400 paying accounts
- Ran the migration off a single-tenant architecture without losing a customer
- Built the research practice that is still in use two leadership changes later

### Senior PM · Northwind · 2015–2018

- Owned the reporting suite, the company's second-largest revenue line
- Ran the first customer advisory board; it survived my departure

## Selected work

| What | Where | Outcome |
| --- | --- | --- |
| Seat-to-hybrid pricing | Meridian | NRR 104% → 118% |
| Outcome-based roadmap | Meridian | Cycle time 11w → 4w |
| Single- to multi-tenant migration | Aperture | Zero customer loss |
| Customer advisory board | Northwind | Still running, 8 years on |
...
- Occasional writing on product operations
- Portuguese (conversational), Tamil (fluent), English (native)
