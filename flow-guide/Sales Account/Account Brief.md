...
jobs:
  - kind: gather
    definition: Account Refresh.md
    as: review
  - kind: keep-sources-fresh
    watch: ["Account Requirements.md", "Account Discovery.md"]
...
```mermaid
flowchart LR
 M[Mara · business sponsor] --> P[Five-document pilot]
 E[Elliot · source owner] --> P
 N[Nina · legal review] --> H[Handover test]
 P --> H
 classDef person fill:#f5e7d9,stroke:#9b6d44,color:#3e2d20
 class M,E,N person
```
