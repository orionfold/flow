...
![One project plan open twice in Orionfold Flow: its written head with a photograph of sticky notes on the left, and on the right the same file's phase flowchart, schedule Gantt chart with a tooltip open, and owners table.](assets/readme/flow-hero-project.webp)
...
Current release: Flow 1.5.5 (1526).
