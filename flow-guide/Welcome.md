...
- **View** on an Ideas card opens the Settings page that owns it, on the right,
...
[[Working With Flow]] is the reference card. [[Annual Operating Review]] is the
long-form document to read when you want the shape of real work.

Flow created this folder and will not overwrite it after today. Everything in
it is an ordinary Markdown file: edit it, move it, or delete what you do not
want.
